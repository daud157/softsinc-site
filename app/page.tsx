  ...
  return (
    <div>
      ...
      <section className="relative overflow-hidden bg-[#FAF9FF] dark:bg-ss-bg">
        ...
        {/* Mobile — reference layout (lg and up hidden) */}
        <Container className="px-4 pt-6 pb-8 md:px-6 lg:hidden">
          <div className="mx-auto flex w-full max-w-[320px] flex-col items-center text-center">
            <h1 className="max-w-[17.5rem] text-[2rem] font-extrabold leading-[1.12] tracking-tight text-ss-text sm:max-w-[19rem] sm:text-[2.375rem]">
            ...
            <p className="mt-3 max-w-[20rem] text-sm leading-relaxed text-ss-text/75 dark:text-ss-text/85">
              Your trusted tools arsenal for AI, career, learning, and productivity.
            </p>

            <div className="relative mt-4 w-full max-w-[20rem]">
              {/* Soft purple glow (no large blur — avoids moiré / “dot” artifacts on some screens) */}
              <div
              ...
              />
              <div className="ss-hero-float flex justify-center">
                <Image
                  ...
                  className="h-auto w-full max-w-[20rem] object-contain [image-rendering:auto] drop-shadow-[0_4px_24px_rgba(124,58,237,0.2)] dark:drop-shadow-[0_4px_28px_rgba(167,139,250,0.2)]"
                />
              </div>
            </div>

            <div className="mt-4 flex w-full max-w-[20rem] flex-col gap-3">
              <Link
                href="/services"
                className="inline-flex w-full items-center justify-center rounded-2xl bg-gradient-to-r from-[#7C3AED] to-[#A855F7] px-5 py-3.5 text-sm font-semibold text-white shadow-sm transition hover:brightness-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#7C3AED]/40 focus-visible:ring-offset-2 focus-visible:ring-offset-[#FAF9FF] dark:from-ss-primary dark:to-ss-accent dark:focus-visible:ring-ss-primary/50 dark:focus-visible:ring-offset-ss-bg"
              >
                Explore Tools
              </Link>
              <div className="grid w-full place-items-stretch">
                <WhatsAppButton
                  ...
                  variant="white"
                  className="!rounded-2xl w-full min-w-0 py-3.5 text-sm ring-emerald-600/25"
                />
              </div>
            </div>

            <TrustBadges className="mt-6 w-full max-w-[20rem] justify-center gap-1.5" />
          </div>
        </Container>
